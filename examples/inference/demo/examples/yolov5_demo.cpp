...
#include "infer/module_infer_rknn2_yolov5.hpp"
#include "track/module_byte_track.hpp"
#include "osd/module_osd.hpp"
...
int main(int argc, char** argv)
{
    ...
    auto infer_module = std::make_shared<ModuleInferRKNN2Yolov5>("yolo_infer", argv[2], argv[3]);
    ...
    auto track_module = std::make_shared<ModuleByteTrack>("yolo_track");
    ...
    auto osd_module = std::make_shared<ModuleOsd>("yolo_osd");
