...
int loadLabelName(const char* locationFilename, char* label[], size_t labelSize)
{
  printf("loadLabelName %s\n", locationFilename);
  return readLines(locationFilename, label, labelSize);
}
...
void deinitLabelName(char* label[], size_t labelSize)
{
