...
set_target_properties(FFMedia::ff_media PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libff_media.so.2.6.0"
  IMPORTED_SONAME_RELEASE "libff_media.so.1"
  )

list(APPEND _IMPORT_CHECK_TARGETS FFMedia::ff_media )
list(APPEND _IMPORT_CHECK_FILES_FOR_FFMedia::ff_media "${_IMPORT_PREFIX}/lib/libff_media.so.2.6.0" )
